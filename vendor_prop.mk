PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.sys.front_camera_sound_type=0 \
    ...
    qemu.hw.mainkeys=0 \
    ril.read.imsi=1 \
    ro.build.display.id=K6309U2BL.HDJ.P0.ANASAPA9DADFDGTJ.1016_1127.V4.12 \
    ...
    ro.pri.current.project=7 \
    ro.pri.false.focus=1 \
    ro.pri.fingerprint=gw9518_tee \
    ro.pri.flash.front=1 \
    ro.pri.front.default.videosize=6 \
    ro.pri.front.mirror=1 \
    ro.pri.front_camera_sound_type=0 \
    ro.pri.fullscreen.support=1 \
    ro.pri.liftcamera.support=1 \
    ro.pri.liftcamera_sound.support=1 \
    ...
    ro.vendor.mediatek.version.release=alps-mp-p0.mp1-V5.97_P10 \
